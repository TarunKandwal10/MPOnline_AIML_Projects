...
**Registration Number:** 23BCE11789

**Application Number:** IN26010732

**Batch Number:** 2B

**Email ID:** tarun.23bce11789@vitbhopal.ac.in 
...
jupyter notebook "Assignment Tarun Kandwal.ipynb"
```
...
```
Adult Census Income Classification/
├── Assignment Tarun Kandwal.ipynb   # Main notebook with full pipeline
...
|---|---|
| **Name** | Tarun Kandwal |
| **Registration No.** | 23BCE11789 |
| **Application No.** | IN26010732 |
| **Batch** | 2B |
